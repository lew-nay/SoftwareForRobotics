...
static const _TurnRobotOn_Request_type_support_symbol_names_t _TurnRobotOn_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cooing_code_interfaces, srv, TurnRobotOn_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cooing_code_interfaces, srv, TurnRobotOn_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cooing_code_interfaces, srv, TurnRobotOn_Request)() {
  return &::cooing_code_interfaces::srv::rosidl_typesupport_c::TurnRobotOn_Request_message_type_support_handle;
}
...
static const _TurnRobotOn_Response_type_support_symbol_names_t _TurnRobotOn_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cooing_code_interfaces, srv, TurnRobotOn_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cooing_code_interfaces, srv, TurnRobotOn_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cooing_code_interfaces, srv, TurnRobotOn_Response)() {
  return &::cooing_code_interfaces::srv::rosidl_typesupport_c::TurnRobotOn_Response_message_type_support_handle;
}
...
static const _TurnRobotOn_type_support_symbol_names_t _TurnRobotOn_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cooing_code_interfaces, srv, TurnRobotOn)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cooing_code_interfaces, srv, TurnRobotOn)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, cooing_code_interfaces, srv, TurnRobotOn)() {
  return &::cooing_code_interfaces::srv::rosidl_typesupport_c::TurnRobotOn_service_type_support_handle;
}
