...
#include "cooing_code_interfaces/msg/detail/task_space_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cooing_code_interfaces::msg::TaskSpacePose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cooing_code_interfaces::msg::TaskSpacePose & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cooing_code_interfaces::msg::TaskSpacePose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cooing_code_interfaces::msg::TaskSpacePose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cooing_code_interfaces::msg::TaskSpacePose *>(
    untyped_ros_message);
...
{
  return &cooing_code_interfaces::msg::typesupport_fastrtps_cpp::_TaskSpacePose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cooing_code_interfaces, msg, TaskSpacePose)() {
  return &cooing_code_interfaces::msg::typesupport_fastrtps_cpp::_TaskSpacePose__handle;
}
