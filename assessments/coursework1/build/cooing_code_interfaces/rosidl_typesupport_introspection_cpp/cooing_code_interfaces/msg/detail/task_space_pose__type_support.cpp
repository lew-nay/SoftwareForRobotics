...
{
  new (message_memory) cooing_code_interfaces::msg::TaskSpacePose(_init);
}

void TaskSpacePose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cooing_code_interfaces::msg::TaskSpacePose *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TaskSpacePose_message_member_array[3] = {
  {
    ...
    offsetof(cooing_code_interfaces::msg::TaskSpacePose, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cooing_code_interfaces::msg::TaskSpacePose, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cooing_code_interfaces::msg::TaskSpacePose, phi_z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TaskSpacePose_message_members = {
  ...
  3,  // number of fields
  sizeof(cooing_code_interfaces::msg::TaskSpacePose),
...
get_message_type_support_handle<cooing_code_interfaces::msg::TaskSpacePose>()
{
  return &::cooing_code_interfaces::msg::rosidl_typesupport_introspection_cpp::TaskSpacePose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cooing_code_interfaces, msg, TaskSpacePose)() {
  return &::cooing_code_interfaces::msg::rosidl_typesupport_introspection_cpp::TaskSpacePose_message_type_support_handle;
}
