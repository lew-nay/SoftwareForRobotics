...
static const _TaskSpacePose_type_support_symbol_names_t _TaskSpacePose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cooing_code_interfaces, msg, TaskSpacePose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cooing_code_interfaces, msg, TaskSpacePose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cooing_code_interfaces, msg, TaskSpacePose)() {
  return &::cooing_code_interfaces::msg::rosidl_typesupport_c::TaskSpacePose_message_type_support_handle;
}
