...
static const _TaskSpacePose_type_support_symbol_names_t _TaskSpacePose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cooing_code_interfaces, msg, TaskSpacePose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cooing_code_interfaces, msg, TaskSpacePose)),
  }
};
...
{
  return &::cooing_code_interfaces::msg::rosidl_typesupport_cpp::TaskSpacePose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cooing_code_interfaces, msg, TaskSpacePose)() {
  return get_message_type_support_handle<cooing_code_interfaces::msg::TaskSpacePose>();
}
