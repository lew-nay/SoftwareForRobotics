...
#include "cooing_code_interfaces/msg/detail/task_space_pose__rosidl_typesupport_fastrtps_c.h"
...
using _TaskSpacePose__ros_msg_type = cooing_code_interfaces__msg__TaskSpacePose;
  ...
  void * untyped_ros_message)
{
  ...
  _TaskSpacePose__ros_msg_type * ros_message = static_cast<_TaskSpacePose__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
size_t get_serialized_size_cooing_code_interfaces__msg__TaskSpacePose(
  const void * untyped_ros_message,
...
static uint32_t _TaskSpacePose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cooing_code_interfaces__msg__TaskSpacePose(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cooing_code_interfaces
size_t max_serialized_size_cooing_code_interfaces__msg__TaskSpacePose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cooing_code_interfaces__msg__TaskSpacePose;
    is_plain =
      (
...
static size_t _TaskSpacePose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cooing_code_interfaces__msg__TaskSpacePose(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cooing_code_interfaces, msg, TaskSpacePose)() {
