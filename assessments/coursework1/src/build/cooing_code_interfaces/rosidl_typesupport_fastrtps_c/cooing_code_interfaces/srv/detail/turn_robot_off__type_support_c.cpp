...
#include "cooing_code_interfaces/srv/detail/turn_robot_off__rosidl_typesupport_fastrtps_c.h"
...
using _TurnRobotOff_Request__ros_msg_type = cooing_code_interfaces__srv__TurnRobotOff_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _TurnRobotOff_Request__ros_msg_type * ros_message = static_cast<_TurnRobotOff_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
...
size_t get_serialized_size_cooing_code_interfaces__srv__TurnRobotOff_Request(
  const void * untyped_ros_message,
...
static uint32_t _TurnRobotOff_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cooing_code_interfaces__srv__TurnRobotOff_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cooing_code_interfaces
size_t max_serialized_size_cooing_code_interfaces__srv__TurnRobotOff_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cooing_code_interfaces__srv__TurnRobotOff_Request;
    is_plain =
      (
...
static size_t _TurnRobotOff_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cooing_code_interfaces__srv__TurnRobotOff_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cooing_code_interfaces, srv, TurnRobotOff_Request)() {
...
using _TurnRobotOff_Response__ros_msg_type = cooing_code_interfaces__srv__TurnRobotOff_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _TurnRobotOff_Response__ros_msg_type * ros_message = static_cast<_TurnRobotOff_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cooing_code_interfaces
size_t get_serialized_size_cooing_code_interfaces__srv__TurnRobotOff_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TurnRobotOff_Response__ros_msg_type * ros_message = static_cast<const _TurnRobotOff_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_cooing_code_interfaces__srv__TurnRobotOff_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cooing_code_interfaces
size_t max_serialized_size_cooing_code_interfaces__srv__TurnRobotOff_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cooing_code_interfaces__srv__TurnRobotOff_Response;
    is_plain =
      (
...
static size_t _TurnRobotOff_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cooing_code_interfaces__srv__TurnRobotOff_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cooing_code_interfaces, srv, TurnRobotOff_Response)() {
...
// already included above
// #include "cooing_code_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "cooing_code_interfaces/srv/turn_robot_off.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cooing_code_interfaces, srv, TurnRobotOff)() {
