...
#include "cooing_code_interfaces/msg/detail/wheel_velocities__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cooing_code_interfaces::msg::WheelVelocities;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cooing_code_interfaces::msg::WheelVelocities *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cooing_code_interfaces::msg::WheelVelocities *>(
    untyped_ros_message);
...
{
  return &cooing_code_interfaces::msg::typesupport_fastrtps_cpp::_WheelVelocities__handle;
}
