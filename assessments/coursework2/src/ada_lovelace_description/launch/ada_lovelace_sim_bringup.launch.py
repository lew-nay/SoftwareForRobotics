...
def generate_launch_description():
    ...
    node_twist_mux = Node(
        ...
        name='node_twist_mux',
        output='screen',
        parameters=[os.path.join(get_package_share_directory('ada_lovelace_description'), 'config', 'twist_mux.yaml')],
        remappings=[('cmd_vel_out', 'ada_lovelace/cmd_vel')]
    )
    ...
    node_ros_gz_bridge = Node(
        ...
        parameters= [{'qos_overrides./ada_lovelace.subscriber.reliability': 'reliable'}],
        remappings= [
                    ('/model/ada_lovelace/cmd_vel',  '/cmd_vel'),
                    ('/model/ada_lovelace/odometry', '/odom'   ),
                    ('/model/ada_lovelace/scan',     '/scan'   ),
                    ('/model/ada_lovelace/tf',       '/tf'     ),
